...
// add the link under h2 
// more work and lots of work needs to be done for this guy
const Resume = () => {
    return (
        <div className='row'>
            <h3 className='header'>Resume <span><img src='/favicon.ico' alt='aboutIcon'></img></span></h3>
            <div className='row'>
                <h5 className='col s12'>Click on this link to download my resume! <a href='' target='_blank'>Resume</a></h5>
            </div>
